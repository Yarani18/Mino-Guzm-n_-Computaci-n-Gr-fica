...
int main()
{
	...
	pointLights[1] = PointLight(1.0f, 1.0f, 1.0f, // Color blanco
		...
		10.5f, 5.0f, 3.0f, // Posición en la parte superior de la lámpara
		0.3f, 0.2f, 0.1f); // Atenuación (constante, lineal, cuadrática)
	pointLightCount++;
...
/*
	//Faro del helicoptero
	spotLights[2] = SpotLight(0.8f, 0.8f, 0.0f, //color amarillo
		3.0f, 5.0f, //intensidad difusa y especular
		-1.5f, 5.0f, 6.0f, //Posicion relativa al helicoptero
		0.0f, -1.0f, 0.0f, //Direccion hacia abajo
		1.0f, 0.1f, 0.001f, //Atenuacion
		10.0f //Angulo de apertura
	);
	spotLightCount++;
*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 mueveFaro = glm::vec3(7.5f, 0.0f, 0.0f) + glm::vec3(0.0f, 0.0f, mainWindow.getmueveCarro());
		spotLights[2].SetFlash(mueveFaro, glm::vec3(0.0f, 0.0f, 1.0f));
	
		/*
		//Mueve luz amarilla del helicoptero de acuerdo si se mueve el helicoptero o no 
		glm::vec3 mueveFaro = glm::vec3(-1.5f, 5.0f, 6.0f) + glm::vec3(mainWindow.getmueveHelicoptero(), 0.0f, 0.0f);
		spotLights[2].SetFlash(mueveFaro, glm::vec3(0.0f, -1.0f, 0.0f));
		*/
		...
		//Lampara texturizada
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(10.5f, -1.0f, 5.0f));
